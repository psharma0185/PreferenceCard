...
public class NewcardTestNg {
	...
	public void newCard() throws InterruptedException, IOException {
		...
		for (int i = 0; i < 2; i++) {
			...
			driver.findElement(By.xpath(
					"/html/body/app-root/app-pref-card/app-edit-card/div/div[2]/div[1]/app-edit-card-info/div/form/div[1]/div/textarea"))
					.sendKeys(data0);
			Thread.sleep(5000);
			driver.findElement(By.xpath(
					"/html/body/app-root/app-pref-card/app-edit-card/div/div[2]/div[1]/app-edit-card-info/div/div[1]/div[1]/div/span/app-autocomplete-dropdown/form/div/input"))
					.click();
			Thread.sleep(2000);
			...
			// DEPARTMENT
			driver.findElement(By.xpath(
					"/html/body/app-root/app-pref-card/app-edit-card/div/div[2]/div[1]/app-edit-card-info/div/div[1]/div[3]/div/div[2]/app-autocomplete-dropdown/form/div/input"))
					.click();
			driver.findElement(By.xpath("//div[@role='listbox']//span[contains(.,'Cardiothor')]")).click();
			Thread.sleep(1000);
			// SPECIALTY
			driver.findElement(By.xpath(
					"/html/body/app-root/app-pref-card/app-edit-card/div/div[2]/div[1]/app-edit-card-info/div/div[1]/div[4]/div/div[2]/app-autocomplete-dropdown/form/div/input"))
					.click();
			...
			// LOCAL PROCEDURE
			driver.findElement(By.xpath(
					"/html/body/app-root/app-pref-card/app-edit-card/div/div[2]/div[1]/app-edit-card-info/div/div[1]/div[5]/div/div[2]/app-autocomplete-dropdown/form/div/input"))
					.click();
			...
			driver.findElement(By.xpath(
					"//div[@class='d-flex flex-column align-items-center th-action-div mr-3']/span/span[@class='add-span cp-pointer ng-star-inserted']/button/span/mat-icon[@class='mat-icon notranslate edit-icon material-icons mat-icon-no-color'][1]"))
					.click();
			Thread.sleep(1000);
			// open Value
			...
			driver.findElement(By.xpath(
					"//div[@class='row d-flex justify-content-center mgt-10 btnDiv']/span/button[@class='mat-focus-indicator addBtn mat-stroked-button mat-button-base']/span/span[@class='ng-star-inserted']"))
					.click();
			Thread.sleep(1000);
			try {
				File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath(
					"//button[@class='mat-focus-indicator btn-stroked publishbtn mat-stroked-button mat-button-base']/span[@class='mat-button-wrapper']"))
					.click();
			Thread.sleep(1000);
			try {
				File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
	...
	static String titleName = "Copy of tester";//card name
...
//		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//textarea[@name='textarea'"))).sendKeys("newprefcardtest03");
		...
		driver.findElement(By.xpath("//textarea[@name='textarea']")).sendKeys("newprefcardtest005");
		Thread.sleep(5000);
		...
		Thread.sleep(5000);
		//replace card
		driver.findElement(By.xpath("//button[contains(.,'Replace') or@class='btn-replace btn-add ng-star-inserted']"))
				.click();
		Thread.sleep(15000);
		//click notes
