...
public class Export_onecard_Select_ImPDF {

	public Export_onecard_Select_ImPDF() {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//button[contains(.,'Individual Cards (.pdf)')]")).click();//Import PDF
		Thread.sleep(1000);
		try {
